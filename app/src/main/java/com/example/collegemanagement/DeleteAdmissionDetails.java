...
public class DeleteAdmissionDetails extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<OnlineAdmissionUserModel> admissionUserModelArrayList;
    AdmissionDeleteAdaptor adaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_admission_details);

        recyclerView = findViewById(R.id.recyclerView);
        admissionUserModelArrayList = new ArrayList<>();
        adaptor = new AdmissionDeleteAdaptor(admissionUserModelArrayList,this);
