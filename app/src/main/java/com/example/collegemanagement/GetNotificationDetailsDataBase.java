...
public class GetNotificationDetailsDataBase extends AppCompatActivity {
...
NotificationDataBase notificationDataBase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_notification_details_data_base);

        recyclerView = findViewById(R.id.recyclerView);
        notificationUserModelArrayList = new ArrayList<>();
        adaptor = new NotificationAdaptor(notificationUserModelArrayList,this);
